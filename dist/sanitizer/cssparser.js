...
exports.parseCssDeclarations = exports.parseCssStylesheet = undefined;
...
(function () {
  ...
  exports.parseCssStylesheet = parseCssStylesheet = function parseCssStylesheet(cssText, handler) {
    var toks = (0, _csslexer.lexCss)(cssText);
  ...
  function atrule(toks, i, n, handler, blockok) {
    ...
    if (i < n && (blockok || toks[i] === ';')) {
      ...
      i = toks[i] === '{' ? block(toks, i, n, handler) : i + 1; // Skip over ';'
  ...
  function selector(toks, i, n, allowSemi) {
    ...
    for (; i < n; ++i) {
      ...
      } else if (tok === ']' && brackets[stackLast] === '[' || tok === ')' && brackets[stackLast] === '(') {
        --stackLast;
      } else if (tok === '{' || tok === '}' || tok === ';' || tok === '@' || tok === ':' && !allowSemi) {
        break;
      }
    }
    if (stackLast >= 0) {
  ...
  exports.parseCssDeclarations = parseCssDeclarations = function parseCssDeclarations(cssText, handler) {
    var toks = (0, _csslexer.lexCss)(cssText);
    for (var i = 0, n = toks.length; i < n;) {
...
exports.parseCssStylesheet = parseCssStylesheet;
