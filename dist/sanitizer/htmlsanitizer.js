...
exports.html_sanitize = exports.html = undefined;
...
var _sanitizecss = require('./sanitizecss');

var _csspropbit = require('./csspropbit');

var _csspropbit2 = _interopRequireDefault(_csspropbit);
...
var html = function (html4) {
  ...
  function safeUri(uri, effect, ltype, hints, naiveUriRewriter) {
    ...
    try {
      var parsed = _uri2.default.parse('' + uri);
      if (parsed) {
      ...
      if (atype !== null) {
        switch (atype) {
          ...
          case html4.atype['STYLE']:
            if ('undefined' === typeof _cssparser.parseCssDeclarations) {
              value = null;
              if (opt_logger) {
                log(opt_logger, tagName, attribName, oldValue, value);
              }
            ...
            (0, _cssparser.parseCssDeclarations)(value, {
              'declaration': function declaration(property, tokens) {
                var normProp = property.toLowerCase();
                (0, _sanitizecss.sanitizeCssProperty)(normProp, tokens, opt_naiveUriRewriter ? function (url) {
...
exports.html = html;
exports.html_sanitize = html_sanitize;
