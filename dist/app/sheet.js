...
exports.default = makeSheetPresenter;
...
function makeSheetPresenter(presenter) {
  var Sheet_ = function (_Component) {
    _inherits(Sheet_, _Component);

    function Sheet_(props) {
      _classCallCheck(this, Sheet_);

      var _this = _possibleConstructorReturn(this, (Sheet_.__proto__ || Object.getPrototypeOf(Sheet_)).call(this, props));
